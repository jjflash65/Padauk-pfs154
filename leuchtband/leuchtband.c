...
// --------------------------------------------------------
//   vordefinierte GPCS-Registerwerte, die die Referenz-
//   spannung am -ue des internen Komparators einstellen
// --------------------------------------------------------
...
/* --------------------------------------------------------
                         comp_init
      Komparatorkonfiguration: -ue an int. Spannungsteiler
                               +ue an P4
...
/* --------------------------------------------------------
     ...
     legt die im Array led_steps gegebenen Werte an den
