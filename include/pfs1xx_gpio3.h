/* ---------------------------------------------------------
  ...
  // PADIER_TMP und PBDIER_TMP nehmen die Bitmanipulationen der
  // Digital Input Enable Register auf, da diese write-only
  // sind. Manipulationen erfolgen zuerst auf diesen Temporaer-
  // variablen (und sind somit gespeichert) und werden danach
  // an das Hardwareregister uebergeben.

  // Definition der Variablen in pdk_init.h
  ...
  #define PA0_float_init()     { PAC &= ~MASK0; PADIER_TMP |= MASK0; PADIER= PADIER_TMP; }
  ...
  #define PA1_float_init()     { PAC &= ~MASK1; PADIER_TMP |= MASK1; PADIER= PADIER_TMP; }
  ...
  #define PA2_float_init()     { PAC &= ~MASK2; PADIER_TMP |= MASK2;  PADIER= PADIER_TMP; }
  ...
  #define PA3_float_init()     { PAC &= ~MASK3; PADIER_TMP |= MASK3;  PADIER= PADIER_TMP; }
  ...
  #define PA4_float_init()     { PAC &= ~MASK4; PADIER_TMP |= MASK4;  PADIER= PADIER_TMP; }
  ...
  #define PA5_float_init()     { PAC &= ~MASK5; PADIER_TMP |= MASK5;  PADIER= PADIER_TMP; }
  ...
  #define PA6_float_init()     { PAC &= ~MASK6; PADIER_TMP |= MASK6;  PADIER= PADIER_TMP; }
  ...
  #define PA7_float_init()     { PAC &= ~MASK7; PADIER_TMP |= MASK7;  PADIER= PADIER_TMP; }
  ...
  #define PB0_float_init()     { PBC &= ~MASK0; PBDIER_TMP |= MASK0;  PBDIER= PBDIER_TMP; }
  ...
  #define PB1_float_init()     { PBC &= ~MASK1; PBDIER_TMP |= MASK1;  PBDIER= PBDIER_TMP; }
  ...
  #define PB2_float_init()     { PBC &= ~MASK2; PBDIER_TMP |= MASK2;  PBDIER= PBDIER_TMP; }
  ...
  #define PB3_float_init()     { PBC &= ~MASK3; PBDIER_TMP |= MASK3;  PBDIER= PBDIER_TMP; }
  ...
  #define PB4_float_init()     { PBC &= ~MASK4; PBDIER_TMP |= MASK4;  PBDIER= PBDIER_TMP; }
  ...
  #define PB5_float_init()     { PBC &= ~MASK5; PBDIER_TMP |= MASK5;  PBDIER= PBDIER_TMP; }
  ...
  #define PB6_float_init()     { PBC &= ~MASK6; PBDIER_TMP |= MASK6;  PBDIER= PBDIER_TMP; }
  ...
  #define PB7_float_init()     { PBC &= ~MASK7; PBDIER_TMP |= MASK7;  PBDIER= PBDIER_TMP; }
